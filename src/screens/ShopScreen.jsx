...
const ShopScreen = ({ onBack }) => {
    const { coins, inventory, shopItems, purchaseItem } = useGameStore();
        ...
        <Workbench>
            ...
            <div className="flex flex-col w-full h-full items-center p-4">
                ...
                <div className="flex items-center justify-between w-full max-w-4xl mb-8">
                    <h1 className="text-4xl font-bold bg-white px-6 py-2 rotate-minus-1 border-2 border-dashed border-gray-400 shadow-sm">
                        WINKEL
                    </h1>
                        ...
                        return (
                            <motion.div
                                ...
                                className={clsx(
                                    ...
                                    isOwned ? "opacity-70 grayscale-[0.5]" : "hover:scale-105 hover:-rotate-1"
                                )}
                            >
                                {/* Price Tag */}
                                {!isOwned && (
                                ...
                                <div className="mt-auto">
                                    {isOwned ? (
                                        <div className="bg-gray-800 text-white px-4 py-2 font-bold uppercase rounded-sm border-2 border-gray-600">
                                            BEZIT
                                        </div>
                                    ) : (
                                        <CardboardButton
